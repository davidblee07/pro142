...
def popular_articles():
    ...
    "Os 20 principais artigos usando o método de filtragem demográfica"
    return jsonify({
...
def recommended_articles():
    ...
    columns_names = ['url' , 'title' , 'text' , 'lang' , 'total_events']
    ...
    "Os 10 principais artigos usando o método de filtragem baseado em conteúdo"
    return jsonify({
